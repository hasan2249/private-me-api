...
@section('content')
    ...
    <section class="blog-area section-padding-100-0">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <form action="{{route('admin.payment.status')}}" class="paymentWidgets" data-brands="VISA MASTER MADA"></form>   
            </div>
        </div>
    </section>
    <!-- ##### Blog Area End ##### -->    
    ...
    $c->id = 6;
    ?>
    <script src="https://test.oppwa.com/v1/paymentWidgets.js?checkoutId={{$c->id}}"></script>
@endsection
